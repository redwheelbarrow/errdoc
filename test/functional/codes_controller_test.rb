...
class CodesControllerTest < ActionController::TestCase
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post :create, :code => { :category => @code.category, :description => @code.description, :number => @code.number }
    end
  ...
  test "should update code" do
    put :update, :id => @code, :code => { :category => @code.category, :description => @code.description, :number => @code.number }
    assert_redirected_to code_path(assigns(:code))
  end
